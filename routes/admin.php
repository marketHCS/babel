...
Route::prefix('/admin')->group(function () {
    ...
    Route::put('users/delete/{id}', 'admin\UsersController@delete')->name('users.delete');
    ...
    Route::put('products/delete/{id}', 'admin\ProductsController@delete')->name('products.delete');
});
