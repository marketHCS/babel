...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        App\WishList::create(["product_id" => 1, "user_id" =>1]);
        App\WishList::create(["product_id" => 2, "user_id" =>1]);
        App\WishList::create(["product_id" => 3, "user_id" =>1]);
        App\WishList::create(["product_id" => 4, "user_id" =>1]);
        App\WishList::create(["product_id" => 5, "user_id" =>1]);
    }
}
