...
GRANT ALL PRIVILEGES ON tienda.* TO 'jamahc s';
...
insert into states
values (2, 'Baja california norte', now(), now());
insert into states
values (3, 'Baja california sur', now(), now());
insert into states
values (4, 'Campeche', now(), now());
insert into states
values (5, 'Coahuila', now(), now());
insert into states
values (6, 'Colima', now(), now());
insert into states
values (7, 'Chiapas', now(), now());
insert into states
values (8, 'Chihuahua', now(), now());
insert into states
values (9, 'Ciudad de México', now(), now());
insert into states
values (10, 'Durango', now(), now());
insert into states
values (11, 'Guanajuato', now(), now());
insert into states
values (12, 'Guerrero', now(), now());
insert into states
values (13, 'Hidalgo', now(), now());
insert into states
values (14, 'Jalisco', now(), now());
insert into states
values (15, 'Mexico', now(), now());
insert into states
values (16, 'Michoacan', now(), now());
insert into states
values (17, 'Morelos', now(), now());
insert into states
values (18, 'Nayarit', now(), now());
insert into states
values (19, 'Nuevo Leon', now(), now());
insert into states
values (20, 'Oaxaca', now(), now());
insert into states
values (21, 'Puebla', now(), now());
insert into states
values (22, 'Queretaro', now(), now());
insert into states
values (23, 'Quintana Roo', now(), now());
insert into states
values (24, 'San Luis Potosi', now(), now());
insert into states
values (25, 'Sinaloa', now(), now());
insert into states
values (26, 'Sonora', now(), now());
insert into states
values (27, 'Tabasco', now(), now());
insert into states
values (28, 'Tamaulipas', now(), now());
insert into states
values (29, 'Tlaxcala', now(), now());
insert into states
values (30, 'Veracruz', now(), now());
insert into states
values (31, 'Yucatan', now(), now());
insert into states
values (32, 'Zacatecas', now(), now());
...
insert into towns
values (2, 'ASIENTOS', 9, now(), now());
insert into towns
values (3, 'CALVILLO', 9, now(), now());
insert into towns
values (4, 'COSIO', 9, now(), now());
insert into towns
values (5, 'DIXON,CA', 14, now(), now());
insert into towns
values (6, 'EL LLANO', 14, now(), now());
insert into towns
values (7, 'JESUS MARIA', 14, now(), now());
insert into towns
values (8, 'logimayab', 22, now(), now());
insert into towns
values (9, 'PABELLON DE ARTEAGA', 22, now(), now());
insert into towns
values (10, 'RINCON DE ROMOS', 22, now(), now());
...
insert into suburbs
values (2, 'Ignacio Zaragoza', 12345, 1, now(), now());
insert into suburbs
values (3, 'Miguel Hidalgo', 87654, 2, now(), now());
insert into suburbs
values (4, 'Satelite', 12098, 2, now(), now());
insert into suburbs
values (5, 'Las rosas', 29340, 2, now(), now());
insert into suburbs
values (6, 'El Romerillal', 10293, 3, now(), now());
insert into suburbs
values (7, 'Paraiso', 76148, 4, now(), now());
insert into suburbs
values (8, '15 de mayo', 12312, 5, now(), now());
insert into suburbs
values (9, 'Independencia', 34345, 6, now(), now());
insert into suburbs
values (10, '5 de febrero', 90343, 7, now(), now());
insert into suburbs
values (11, 'Primavera', 90812, 8, now(), now());
insert into suburbs
values (12, '10 de abril', 90564, 8, now(), now());
insert into suburbs
values (13, 'Iguazú', 789321, 8, now(), now());
insert into suburbs
values (14, 'Paseos de san Miguel', 12221, 9, now(), now());
insert into suburbs
values (15, 'Mompani', 23908, 10, now(), now());
...
insert into addresses
values (2, 'Los arcos', 45, 23, 2, now(), now());
insert into addresses
values (3, 'Margarita', 91, null, 3, now(), now());
insert into addresses
values (4, 'Amatista', 12, 2, 4, now(), now());
insert into addresses
values (5, 'El globo', 90, null, 5, now(), now());
insert into addresses
values (7, 'Independecia', 13, null, 7, now(), now());
insert into addresses
values (6, 'Flores Magon', 2, null, 6, now(), now());
insert into addresses
values (8, 'De la Paz', 9, null, 8, now(), now());
insert into addresses
values (9, 'Palameres', 8, null, 9, now(), now());
insert into addresses
values (10, 'Portal de San Miguel', 34, null, 10, now(), now());
insert into addresses
values (11, 'El Lienzo', 3, null, 11, now(), now());
insert into addresses
values (12, 'Las Flores', 12, null, 12, now(), now());
insert into addresses
values (13, 'Escoral', 24, null, 13, now(), now());
insert into addresses
values (14, 'Parlamento', 1034, null, 14, now(), now());
insert into addresses
values (15, 'La RAza', 153, null, 15, now(), now());
insert into addresses
values (16, 'Fray Servando', 210, null, 1, now(), now());
insert into addresses
values (17, 'Córdova', 113, null, 2, now(), now());
insert into addresses
values (18, 'Anzures', 912, null, 3, now(), now());
insert into addresses
values (19, 'Los Heróes', 26, null, 4, now(), now());
insert into addresses
values (20, 'Condesa', 89, null, 5, now(), now());
insert into addresses
values (21, 'Paseos', 19, 4, 6, now(), now());
insert into addresses
values (22, 'Luis Linas', 5, 6, 7, now(), now());
insert into addresses
values (23, 'Tlaloc', 91, null, 8, now(), now());
insert into addresses
values (24, 'Laguna', 200, 89, 9, now(), now());
insert into addresses
values (25, 'Mayrán', 409, 233, 10, now(), now());
insert into addresses
values (26, 'Av. Revolución', 40, null, 11, now(), now());
insert into addresses
values (27, 'Gúzman', 349, 345, 12, now(), now());
insert into addresses
values (28, 'La Negreta', 93, null, 13, now(), now());
insert into addresses
values (29, 'Onega', 1234, null, 14, now(), now());
insert into addresses
values (30, 'Amatista', 34, null, 3, now(), now());
insert into addresses
values (31, 'Del placer', 23, null, 7, now(), now());
insert into addresses
values (32, 'Miguel Hidalgo', 67, null, 13, now(), now());
...
(
    ...
    nicknameUser         varchar(50) unique,
    typeUser             int,
    created_at           timestamp,
    updated_at           timestamp,
...
insert into users (id, name, email, email_verified_at, password, nicknameUser, typeUser, created_at, updated_at)
