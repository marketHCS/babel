...
insert into Cliente
values (0, "Sergio", "López", "Sánchez", "Vafer Materiales", "Pay pal", 2, "Sergio123"),
       (0, "Antonio", "Perez", "Hernández", "Comercializadora Salazar", "Pay pal", 4, "Antonio1"),
       (0, "Victor", "Tapia", "Martinez", "Raksa", "Pay pal", 4, "Victor1"),
       (0, "Carlos", "Medina", "Noguez", "Mggm", "Credito", 5, "Carlos1"),
       (0, "Omar", "Mejía", "Rodriguez", "Cemex", "Credito", 7, "Omar1123");
...
#     constraint foreign key (id_estado) references estado_producto (id_estado) on delete restrict on update cascade
);

insert into Producto
values (0, 1, "Gerber Body ", "Set de 5 Unidades variadas de Mono para niños", 250, 350, "Algodón", null, 1, 1, 1),
       (0, 1, "Camisa blanca, estampado 2", "Tommy Hilfiger CD87176401", 220, 340, "90% algodón", null, 2, 2, 2),
       (0, 1, "Camisa bajo con nudo", "Camisa amarilla, con nudo bajo de manga a capas", 100, 180,
        "Poliéster y algodón",
        null, 3, 3, 3),
       (0, 1, "Sudadera Liso Rosa", "Sudaderas Cordón Liso, hombro caido Rosa Casual", 290, 560,
        "97% Poliéster, 3% spandex", NULL, 4, 4, 4),
       (0, 1, "Pantalón chino", "Pantalón  chino cafe regular fit·", 780, 1000, "97% Algodón 3% Elastano", null, 5, 5,
        5),
       (0, 1, "Gerber Body estampado ", "Gerber body Mono para niños", 150, 250, "Algodón 100%", null, 1, 1, 1),
       (0, 1, "Camisa roja estampado 2", "Camisa roja Tommy Hilfiger ", 320, 440, "90% algodón", null, 2, 2, 2),
       (0, 1, "Playera top", "Camisa amarilla, con nudo bajo de manga a capas", 100, 180, "Poliéster y algodón", null,
        3,
        3, 3),
       (0, 1, "Sudadera Estampado ", "Sudaderas Cordón Liso, hombro caido Rosa Casual", 290, 560, "97% Poliéster", NULL,
        4,
        4, 4),
       (0, 1, "Pantalón mezclica", "Pantalón  mezclilla regular fit·", 780, 1000, "97% Algodón 3% Elastano", null, 5, 5,
        5);
...
delete from inventario where id_inv !=0;

insert into inventario
values (0, 54, "De temporada", 1, 1),
       (0, 124, "De temporada", 5, 1),
       (0, 200, "De temporada", 9, 1),
       (0, 230, "De temporada", 13, 1),
       (0, 10, "Liquidación", 17, 1),
       (0, 13, "De temporada", 21, 1),
       (0, 200, "De temporada", 25, 1),
       (0, 100, "De temporada", 29, 1),
       (0, 120, "De temporada", 30, 1),
       (0, 21, "Liquidación", 3, 1),
       (0, 54, "De temporada", 2, 2),
       (0, 124, "De temporada", 6, 2),
       (0, 200, "De temporada", 10, 2),
       (0, 230, "De temporada", 14, 2),
       (0, 10, "Liquidación", 18, 2),
       (0, 13, "De temporada", 22, 2),
       (0, 200, "De temporada", 26, 2),
       (0, 100, "De temporada", 30, 2),
       (0, 120, "De temporada", 3, 2),
       (0, 21, "Liquidación", 3, 2),
       (0, 54, "De temporada", 7, 3),
       (0, 124, "De temporada", 11, 3),
       (0, 200, "De temporada", 15, 3),
       (0, 230, "De temporada", 19, 3),
       (0, 10, "Liquidación", 23, 3),
       (0, 21, "Liquidación", 27, 3),
       (0, 100, "De temporada", 31, 3),
       (0, 80, "De temporada", 1, 3),
       (0, 90, "De temporada", 5, 3),
       (0, 20, "Liquidación", 4, 3),
       (0, 18, "Liquidación", 1, 3);
...
delete from venta where id_vta = 3;

update venta set id_vta=10 where id_vta !=0;
...
(
    ...
    id_inv   int,
    cantidad int,
    constraint fk20 foreign key (id_vta) references Venta (id_vta) ON DELETE RESTRICT ON UPDATE restrict ,
