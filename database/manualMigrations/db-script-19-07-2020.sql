...
(
    ...
    constraint foreign key (phone_id) references phones (id)
);
...
#     avatar               varchar(50) unique,
    ...
    constraint foreign key (typeUser_id) references typeUsers (id),
...
# insert into users (id, name, email, email_verified_at, password, typeUser, rfc, created_at, updated_at)
# values (0, 'Jama', 'jamahcs@outlook.com', now(), 'acceso.jama', 2, null, now(), now()),
#        (0, 'Veronica', 'verohcs@outlook.com', now(), 'acceso.vero', 2, null, now(), now()),
#        (0, 'Alma', 'alopez@uteq.edu.mx', now(), 'acceso.alma', 2, null, now(), now()),
#        (0, 'Victor', 'vaguilar@uteq.edu.mx', now(), 'acceso.victor', 2, null, now(), now()),
#        (0, 'Antonio', 'asanchezc@uteq', now(), 'acceso.antonio', 1, 'sdfg234567', now(), now()),
#        (0, 'Andrea', 'andreahcs@outlook.com', now(), 'acceso.andrea', 1, 'lkhgf345', now(), now()),
#        (0, 'Alan', 'alanhcs@outlook.com', now(), 'acceso.alan', 1, 'Cjhgfd678', now(), now()),
#        (0, 'Vanessa', 'vanessahcs@outlook.com', now(), 'acceso.vane', 1, 'p987654f', now(), now());
...
(
    id               int NOT NULL AUTO_INCREMENT,
    statusProduct_id int,
    nameProduct      varchar(100),
    description_prod text,
    costo_prod       float,
    precio_prod      float,
    descuento        float,
    material_prod    varchar(50),
